    ...
    <div class="max-w-[850px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div class="space-y-1">
          ...
          <h1 class="text-2xl font-black text-slate-900 tracking-tight">{{ isEditing ? 'Edit Order ' + orderId : 'Create New Order' }}</h1>
          <p class="text-sm text-slate-500 font-medium">Fill in the customer and product details to register or update a transaction.</p>
        </div>
      ...
      <form [formGroup]="orderForm" class="space-y-6">
        ...
        <div class="card-stitch p-8 bg-white space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div class="md:col-span-6 space-y-1.5">
              ...
              <div class="relative">
                <select formControlName="productName" class="select-stitch cursor-pointer">
            ...
            <div class="md:col-span-3 space-y-1.5">
              ...
              <div class="relative">
                 ...
                 <input type="number" [value]="orderForm.get('productPrice')?.value" readonly 
                        class="input-stitch bg-slate-100 text-text-muted cursor-not-allowed pl-8">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-stitch p-8 bg-white space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-1.5">
              ...
              <div class="relative">
                <select formControlName="province" class="select-stitch cursor-pointer">
            ...
            <div class="space-y-1.5">
              ...
              <div class="relative">
                <select formControlName="city" class="select-stitch cursor-pointer disabled:bg-slate-100 disabled:cursor-not-allowed">
            ...
            <div class="md:col-span-2 space-y-1.5">
              ...
              <textarea formControlName="address1" placeholder="Full delivery address, apartment, suite, etc." rows="3"
                        class="input-stitch resize-none h-auto py-3"></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
           <div class="card-stitch p-8 bg-white space-y-4">
              ...
              <div class="relative">
                <select formControlName="status" class="select-stitch cursor-pointer">
           ...
           <div class="card-stitch p-8 bg-white space-y-4">
              ...
              <textarea formControlName="notes" placeholder="Gift instructions, delivery preference..." rows="1"
                        class="input-stitch resize-none h-[46px]"></textarea>
           </div>
        </div>
        ...
        <div class="flex items-center justify-end space-x-4 pt-4">
           <button (click)="goBack()" type="button" class="px-8 py-2.5 rounded-ui border border-border text-text font-bold text-sm bg-white hover:bg-slate-50 transition-all active:scale-95">
              Cancel
           </button>
           <button (click)="submitOrder()" 
                   type="button"
                   [disabled]="orderForm.invalid || isSaving || isLoadingOrders()"
                   class="bg-primary hover:bg-blue-700 text-white px-10 py-2.5 rounded-ui shadow-md hover:shadow-lg disabled:opacity-50 disabled:shadow-none transition-all active:scale-95 text-sm font-bold flex items-center justify-center space-x-3">
              <mat-spinner diameter="18" strokeWidth="2.5" *ngIf="isSaving || isLoadingOrders()" class="text-white"></mat-spinner>
               ...
               <span *ngIf="isSaving && isEditing">Updating Order...</span>
               <span *ngIf="isSaving && !isEditing">Saving Order...</span>
